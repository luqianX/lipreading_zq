...
class SequenceBeamSearch(object):
    ...
    def __init__(self, symbols_to_logits_fn, vocab_size, batch_size, beam_size,
    ...
    """
        ...
        finished_scores *= tf.to_float(
            finished_flags)  # set filler scores to zero
    ...
    """
        ...
        finished_flags = tf.concat(
            [finished_flags, new_finished_flags], axis=1)
