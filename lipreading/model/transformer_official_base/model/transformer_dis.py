  ...
  """
    ...
    """
        ...
        self.embedding_softmax_layer = embedding_layer.EmbeddingSharedWeights(
            params["target_vocab_size"], params["hidden_size"], method="gather")
...
#inputs_unpadded_length   position embedding?
            ...
            #    return self.predict(inputs, attention_bias)
            else:
                logits = self.decode(targets, encoder_outputs, attention_bias)
            #    logits = self.decode(targets, inputs, attention_bias)
                return logits
